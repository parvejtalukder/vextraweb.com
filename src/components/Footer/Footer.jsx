...
const Footer = () => {
    return (
        <div>
            <section className="footer bg-gray-50/30 sm:footer-horizontal text-neutral-content p-10 rounded-t-2xl">
              <nav>
                <h6 className="footer-title text-[#008bfd] text-xl font-bold">Services</h6>
              ...
              <nav>
                <h6 className="footer-title text-[#008bfd] text-xl font-bold">Company</h6>
              ...
              <nav>
                <h6 className="footer-title text-[#008bfd] text-xl font-bold">Legal</h6>
