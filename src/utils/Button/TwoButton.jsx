...
const TwoButton = ({text}) => {
    return (
        <div className='group bg-[#004AAD] duration-1000 px-5 py-2 max-w-44 flex justify-center items-center rounded-4xl border-2 border-[#004AAD] cursor-pointer transition-all hover:bg-transparent'>
