      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-6 items-center justify-items-center">
        {dataSlider.map((brand) => (
          <a
            ...
            className="flex items-center justify-center p-4 bg-white duration-1000 hover:bg-blue-500 transition-all rounded-lg shadow-md hover:shadow-xl duration-300"
          >
            <img
              src={brand.logo}
              alt={`Logo ${brand.id}`}
